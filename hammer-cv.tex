...
\item \textbf{SRC Judge}: PLDI 2016 Student Research Competition.
  
\item \textbf{Program Committee (PC) member}: PLAS 2015
...
\begin{itemize}
\item \href{http://www.cs.umd.edu/~hammer/adapton}{\textsc{Adapton}: Composable, Demand-Driven Incremental Computation}.
  %   
  \textsc{Adapton} provides library primitives (currently in OCaml and Python)
