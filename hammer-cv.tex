...
\\
%Assistant Professor
\textbf{Independent Researcher and Educator}
}
...
\begin{minipage}[t]{0.495\textwidth}
  Email: \href{mailto:matthewhammer@gmail.com}{matthewhammer@gmail.com} \\
...
\begin{itemize}
  \item  \href{https://dfinity.org/}{DFINITY Foundation} (Jan 2019--Nov 2023)
  \\
  Researcher and Engineer
  \\
  Languages Team \& SDK Team
  \\
  \href{https://github.com/dfinity/motoko}{Motoko Compiler}, \href{https://github.com/caffeinelabs/motoko-base}{original \texttt{base} library}, and \href{https://github.com/dfinity/cancan}{prototype applications} (\href{https://github.com/dfinity/feedback}{another one}).
  
\end{itemize}

\section*{Academic Experience}
\begin{itemize}
  \item  {University of Colorado, Boulder} (Aug 2015--Dec 2018)
  \\
  \textbf{Assistant Professor} 

 \item  {University of Maryland, College Park} (Aug 2012--Aug 2015)
  \\
...
\item\href{https://eprint.iacr.org/2019/402.pdf}{\textit{{{ILC:} a calculus for composable, computational cryptography}}}
\\
Kevin Liao, \underline{Matthew A. Hammer} and Andrew Miller.
\\
Programming Language Design and Implementation (\textbf{PLDI 2019}).
\\
...
\ReviewItemsBegin
\ReviewItem{ Graduate Program Committee, Fall 2015---Spring 2018}
\ReviewItem{ Educational Technology Committee, Spring 2017---Spring 2018}
\ReviewItemsEnd

\item Colloquium Chair, Fall 2016---Spring 2018
