...
\task{30} Implement the theory of Language~\T in OCaml, along with tests.

\task{30} Extend the theory of Language~\T with Pairs and Sums.  Include additional tests.
